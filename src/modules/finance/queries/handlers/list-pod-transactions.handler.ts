...
import { ListPodTransactionsQuery } from '../list-pod-transactions.query';
import { PaymentEntity } from '../../entities/payment.entity';
import { PayoutEntity } from '../../entities/payout.entity';
import { PodMembershipEntity } from '../../../pods/entities/pod-membership.entity';

@QueryHandler(ListPodTransactionsQuery)
export class ListPodTransactionsHandler
  implements IQueryHandler<ListPodTransactionsQuery, TransactionListResult>
{
  constructor(
  ...
  async execute(
    query: ListPodTransactionsQuery,
    ...
    const paymentWhere: any = { account: query.accountId, pod: query.podId };
    const payoutWhere: any = { account: query.accountId, pod: query.podId };
